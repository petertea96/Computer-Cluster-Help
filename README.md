...
On your own device, you can easily source your R scripts and have them run on R/RStudio (Aside: You should use RStudio instead of R. You can thank me later...). When you use a supercomputer, however, you'll need to perform one extra step to run your R scripts. This extra step involves writing BASH Shell scripts. BASH scripts serve as instructions to the supercomputer to properly run your R scripts. At minimum, the instructions you write in your BASH Shell scripts should tell the Supercomputer to: 
